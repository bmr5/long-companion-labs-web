...
export async function getCollectionProducts({
  ...
  if (!endpoint) {
    console.log(
      `Using mock data for getCollectionProducts('${collection}') - Shopify not configured`
    );
    return mockProducts;
  }
...
export async function getProduct(handle: string): Promise<Product | undefined> {
  ...
  if (!endpoint) {
    console.log(
      `Using mock data for getProduct('${handle}') - Shopify not configured`
    );
...
export async function getProductRecommendations(
  ...
  if (!endpoint) {
    console.log(
      `Using mock data for getProductRecommendations - Shopify not configured`
    );
...
export async function getProducts({
  ...
  if (!endpoint) {
    console.log(`Using mock data for getProducts - Shopify not configured`);
